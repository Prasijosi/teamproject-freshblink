...
<div class="container-fluid main-content">
	...
	<h3>Trader New Product Request</h3>
		...
		<table id="myTable" class="table table-bordered" width="100%">
			<div class="row">
				<div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 d-flex align-items-center justify-content-start">
					...
					echo "<h5>$count3 New Product Request</h5>";
					?>
				</div>
			...
			<tbody>
				...
				while ($row = oci_fetch_assoc($qry)) {
					...
					<td class='text-center'>$pprice</td>
					 ...
					 <form method='POST' action='product_request_process.php'>
					...
					<br>
					<button type='submit' class='btn btn-danger' name='submit2' disabled >Decline</button>
					";
					}
