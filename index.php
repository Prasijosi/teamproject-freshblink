...
$popular_products = [
    [
        'img' => 'images/bakery_03.png',
        'name' => 'Cake',
        'category' => 'Bakery',
        'link' => 'product_details.php?product_id=1001',
    ],
    [
        'img' => 'images/bakery_04.png',
        'name' => 'Donught',
        'category' => 'Bakery',
        'link' => 'product_details.php?product_id=1002',
    ],
    [
        'img' => 'images/bakery_01.png',
        'name' => 'Wholegrain Bread',
        'category' => 'Bakery',
        'link' => 'product_details.php?product_id=1003',
    ],
    [
        'img' => 'images/bakery_02.png',
        'name' => 'Cookies',
        'category' => 'Bakery',
        'link' => 'product_details.php?product_id=1004',
    ],
    [
        'img' => 'images/butcher_02.png',
        'name' => 'Mutton',
        'category' => 'Butcher',
        'link' => 'product_details.php?product_id=1005',
    ],
    [
        'img' => 'images/butcher_03.png',
        'name' => 'Chicken',
        'category' => 'Butcher',
        'link' => 'product_details.php?product_id=1006',
    ],
    [
        'img' => 'images/butcher_01.png',
        'name' => 'Pork',
        'category' => 'Butcher',
        'link' => 'product_details.php?product_id=1007',
    ],
    [
        'img' => 'images/butcher_04.png',
        'name' => 'Buff Meat',
        'category' => 'Butcher',
        'link' => 'product_details.php?product_id=1008',
    ],
    [
        'img' => 'images/greengrocery_01.png',
        'name' => 'Brocolli',
        'category' => 'Greengrocery',
        'link' => 'product_details.php?product_id=1008',
    ],
    [
        'img' => 'images/greengrocery_02.png',
        'name' => 'Spinach',
        'category' => 'Greengrocery',
        'link' => 'product_details.php?product_id=1010',
    ],
    [
        'img' => 'images/greengrocery_03.png',
        'name' => 'Apple',
        'category' => 'Greengrocery',
        'link' => 'product_details.php?product_id=1011',
    ],
    [
        'img' => 'images/greengrocery_04.png',
        'name' => 'Avocado',
        'category' => 'Greengrocery',
        'link' => 'product_details.php?product_id=1012',
    ],
    [
        'img' => 'images/fishmonger_01.png',
        'name' => 'Rohu Fish',
        'category' => 'Fishmonger',
        'link' => 'product_details.php?product_id=1013',
    ],
    [
        'img' => 'images/fishmonger_02.png',
        'name' => 'Cat Fish',
        'category' => 'Fishmonger',
        'link' => 'product_details.php?product_id=1014',
    ],
    [
        'img' => 'images/fishmonger_03.png',
        'name' => 'Prawn',
        'category' => 'Fishmonger',
        'link' => 'product_details.php?product_id=1015',
    ],
];
